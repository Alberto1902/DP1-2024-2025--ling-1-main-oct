...
export default function AchievementEdit() {
    ...
    return (
        ...
        <div className="auth-page-container">
            <div className="auth-form-container" style={{height: '83vh', marginTop: '16vh'}}>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <div className="custom-form-input">
                        ...
                        >
                            ...
                            <option value="TIME_PLAYED">TIME_PLAYED</option>
                    ...
                    <div className="custom-form-input">
                        <Label for="profilePictureUri" className="custom-form-input-label-non-mandatory">
                            Profile Picture URI
                        </Label>
                        <Input
                            type="text"
                            ...
                            value={achievement.profilePictureUri || null}
                            onChange={handleChange}
                            className="custom-input"
                        />
                    </div>
                    <div className="custom-form-input">
                        <Label for="themeUri" className="custom-form-input-label-non-mandatory">
                            Theme URI
                        </Label>
                        <Input
                            type="text"
                            name="themeUri"
                            id="themeUri"
                            value={achievement.themeUri || null}
                            onChange={handleChange}
                            className="custom-input"
                        />
                    </div>
